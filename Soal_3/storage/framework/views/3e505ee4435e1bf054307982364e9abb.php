                    ...
                    <div class="col col-12 col-sm-6 col-md-4">
                        <div class="card shadow border-0">
                            <svg class="bd-placeholder-img card-img-top" width="100%" height="225">
                                <image class="image-package" href="images/content/<?php echo e($menu->images); ?>" />
                            </svg>
                            <div class="card-body">
                                <h4 class="card-title" data-category="<?php echo e($menu->kategori); ?>"><?php echo e($menu->nama_menu); ?></h4>
                                <p class="card-text"><?php echo e($menu->deskripsi); ?></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <button type="button"
                                            class="btn btn-lg btn-outline-warning"><?php echo e($menu->harga); ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row g-3 py-5">
                <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card border-0 col-md-6 col-lg-4 bg-transparent my-3">
                        <img src="<?php echo e(asset('images/content/' . $article->images)); ?>" alt="">
                        <div class="card-body px-0">
                            <h2><?php echo e($article->judul); ?></h2>
                            <p class="text-secondary"><?php echo e(Illuminate\Support\Str::words($article->isi, 20, '...')); ?></p>

                            <a href="<?php echo e(route('article.show', $article->id)); ?>" class="btn btn-outline-warning">Read
                                More</a>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="flex">
                                            ...
                                            <div class="profile">
                                                <img src="" alt="">
                                                <a href="#"><?php echo e($ulasan->name); ?></a>
                                                <span>lalala</span>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Xampp\htdocs\crudtest\resources\views/user/home.blade.php ENDPATH**/ ?>