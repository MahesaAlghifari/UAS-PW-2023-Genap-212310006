...
<div class="container">
    <div class="card">
        <article class="card-body">
            <!-- <a href="<?php echo e(url('register')); ?>" class="float-right btn btn-outline-primary">Sign up</a> -->
...
<?php echo $__env->make('templates/base2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Xampp\htdocs\crudtest\resources\views/login.blade.php ENDPATH**/ ?>